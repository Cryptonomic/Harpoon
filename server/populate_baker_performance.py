...
TABLE = "baking_info.baker_performance"
COLUMNS = ("baker",
           "cycle",
           "num_baked",
           "num_stolen",
...
def calculate_grade(baker, current_cycle):
    ...
    #   return baker, grade, num_blocks_per_stake, num_blocks_baked, s, m, d, staking_balance
    return baker, current_cycle, num_blocks_baked, num_blocks_stolen, num_blocks_missed, \
        num_endorsements_in_baked, num_endorsements_in_stolen, num_endorsements_in_missed, grade
